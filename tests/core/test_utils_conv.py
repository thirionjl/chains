...
def test_im2col_1channel_1example_stride1():
    ...
    np.testing.assert_array_equal(uc.im2col(inputs, filters_shape),
...
def test_im2col_1channel_1example_stride2():
    inputs = np.arange(1, 17).reshape(1, 1, 4, 4)
    filters_shape = (1, 1, 2, 2)
    np.testing.assert_array_equal(uc.im2col(inputs, filters_shape, stride=2),
...
def test_col2im():
    ...
    np.testing.assert_array_equal(expected,
                                  uc.col2im(cols, inputs_shape, filters_shape))

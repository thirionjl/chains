...
def test_batch_norm_computation_and_gradient():
    ...
    assert_allclose(bn.output, array([[0.12753308, 1.1489942, -1.276527],
                                      [1.29037, -0.35706627, -0.9333031]]),
                    atol=1e-7)
    ...
    assert_allclose(d_x, array([[-0.40287876, 0.23186469, 0.17101419],
                                [0.33326817, -1.4796133, 1.1463442]]),
                    atol=1e-6)
